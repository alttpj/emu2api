module io.github.alttpj.emu2api.source.config.toml {
  ...
  opens io.github.alttpj.emu2api.config.toml to com.fasterxml.jackson.dataformat.toml;
  exports io.github.alttpj.emu2api.config.toml to com.fasterxml.jackson.dataformat.toml;
}
